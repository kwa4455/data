...
def merge_start_stop(df):
    ...
    desired_order = [
        ...
        "Wind Speed_Start", "Wind Direction_Start", "Elapsed Time (hr)_Start", "Flow Rate (L/min)_Start",
        ...
        "Wind Speed_Stop", "Wind Direction_Stop", "Elapsed Time (hr)_Stop", "Flow Rate (L/min)_Stop",
